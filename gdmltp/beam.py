...
def _sample_energy_mev(energy, n, rng):
    ...
    if mode in ("mudecay_numu", "mudecay_nue", "mudecay_e"):
        # Daughters of in-flight muon decay (energy.value = parent muon
        ...
        #   e- / e+           : the same pdf as nu_mu -- for an unpolarized muon
        #     the charged lepton and the nu_mu share the rest-frame Michel
        #     spectrum 2x^2(3-2x), hence the same boosted one. (y is the TOTAL
        #     energy fraction; the 511 keV rest mass is dropped, which matters
        #     only at the very bottom of a GeV-and-above spectrum.)
